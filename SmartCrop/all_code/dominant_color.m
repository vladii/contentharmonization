function dominant_color(image_path, text, font, font_size, X, Y, outpath)
    image_name = substr(image_path, rindex(image_path, '/')+1);
    ...
    outname = [outpath 'dominant_' image_name];
    imwrite(show_colors, outname);

    outname = [outpath 'cropped_' image_name];
    ...
    outname = [outpath 'dominant_one_' image_name];
    ...
    outname = [outpath 'complement_' image_name];
